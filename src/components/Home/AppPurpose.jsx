...
function AppPurpose() {
    return (
        <div className="mt-6 p-4 bg-stone-100 rounded-lg text-sm text-gray-700 flex flex-col gap-10">
            <h2 className="text-xl sm:text-3xl mb-4 text-[#652F74]">What is <span className="font-semibold">Ask Carrie?</span></h2>

            <div className="flex flex-col sm:flex-row items-center gap-4">
                <div className="bg-[#652F74] text-white p-3 rounded-full flex-shrink-0">
                    <i className="fa fa-search text-2xl sm:text-3xl" aria-hidden />
                </div>
                <p className="mb-2 text-base sm:text-lg min-w-0">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4">
                <div className="bg-[#652F74] text-white p-3 rounded-full flex-shrink-0">
                    <i className="fa fa-folder text-2xl sm:text-3xl" aria-hidden />
                </div>
                <p className="mb-2 text-base sm:text-lg min-w-0">
